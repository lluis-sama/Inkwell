...
Inkwell es una aplicación de escritorio de código abierto para Linux diseñada para escritores. Organiza tu obra, escribe sin distracciones, y usa IA para mejorar tu narrativa — todo con tus archivos en tu disco, sin cuentas, sin suscripciones.
...
**Anthropic (nube)** — obtén una API key en [console.anthropic.com](https://console.anthropic.com) e introdúcela en Configuración → IA.

**Ollama (local)** — instala [Ollama](https://ollama.ai), descarga un modelo y configura la URL en Configuración → IA:
...
**Servidor OpenAI-compatible** — compatible con llama.cpp, LM Studio, LocalAI, Jan y otros. Introduce la URL de tu servidor en Configuración → IA.
...
<div align="center">
  <sub>Hecho con ♥ para escritores · <a href="https://codeberg.org/TU_USUARIO/inkwell">Codeberg</a></sub>
</div>
